...
public class Host {
    public static void main(String[] args) throws EnclaveLoadException, IOException {
        ...
        // because the CPU must hash the contents of the enclave binary.
         // A remote attestation procedure is then performed involving Intel's servers
        ...
        // to the client, here.
        // Causes the enclave to be initialized/loaded and the Enclave object constructed inside

        // Note that an EnclaveHost allocates memory out of a pool called the "enclave page cache" which is a machine-wide
        // limited resource. It'll be freed if the host JVM quits, but it's good practice to close the EnclaveHost
        // object by calling close on it when done.
